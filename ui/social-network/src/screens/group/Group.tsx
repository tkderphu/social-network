...
function Group() {
    ...
    const [openDialogGroupForm, setOpenDialogGroupForm] = useState(false)
    useEffect(() => {
        ...
        <>
            <div className="row mt-3 m-1">
                ...
                <div className="col-3 sticky-sidebar ">
                    ...
                    <button  onClick={() => setOpenDialogGroupForm(true)} type="button" className="w-100 mt-2 p-2 create-group" data-toggle="modal" data-target=".form-group">Large modal</button>
                    {openDialogGroupForm && (
                        <div className="modal">
                        <div className="modal-content">
                            <h2>Chi tiết bài viết 23</h2>
                            <input/>
                            <button onClick={() => {
                                setOpenDialogGroupForm(false)
                            }}>Đóng</button>
                        </div>
                    </div>
                    )}
