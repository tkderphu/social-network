...
import ModalCustomer from "../../components/modal/ModalCustom"
...
import "./Chat"
import { ChangeNickNameForm, ChangeThumbnailForm, CreateGroupConversationForm, SeeMember } from "./Form"
...
function UserChatBox(props: { removeThisUserChatboxFn: any, user?: ProfileSimpleResp }) {
    ...
    const [openCreateGroupConversation, setOpenCreateGroupConversation] = useState(false)
    const [openChangeNickname, setOpenChangeNickname] = useState(false)
    const [openChangeThumbnail, setOpenChangeThumbnail] = useState(false)
    const [openSeeMembers, setOpenSeeMembers] = useState(false)
    ...
    return (
        <>
            ...
            <ChangeNickNameForm conversationId={1} open={openChangeNickname} setOpen={setOpenChangeNickname} />
            <ChangeThumbnailForm conversationId={1} open={openChangeThumbnail} setOpen={setOpenChangeThumbnail} />
            <SeeMember conversationId={1} open={openSeeMembers} setOpen={setOpenSeeMembers} />
            <CreateGroupConversationForm open={openCreateGroupConversation} setOpen={setOpenCreateGroupConversation} />

            <div className="user-chat-box card">
                <div className="d-flex justify-content-between">
                    <div className="d-flex align-items-center">
                        <div className="dropdown">
                            <button className="btn btn-light" id="chat-dropdrown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <div className="d-flex align-items-center">
                            ...
                            <ul className="dropdown-menu" aria-labelledby="chat-dropdrown" >
                                <li><a className="dropdown-item" onClick={() => setOpenCreateGroupConversation(true)} href="#">Create group</a></li>
                                <li><a className="dropdown-item" onClick={() => setOpenChangeNickname(true)} href="#">Change nickname</a></li>
                                <li><a className="dropdown-item" onClick={() => setOpenChangeThumbnail(true)} href="#">Change thumbnail</a></li>
                                <li><a className="dropdown-item" onClick={() => setOpenSeeMembers(true)} href="#">See members</a></li>
                                <li><a className="dropdown-item"  href="#" onClick={leaveGroup}>Leave group conversation</a></li>
